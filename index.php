...
<a href="#" id="logo-link" class="text-xl font-bold text-white flex-shrink-0 pr-4" aria-label="Volver a la página de inicio">
...
<button id="mobile-menu-button" class="text-gray-300 hover:text-white" aria-label="Abrir menú de navegación">
